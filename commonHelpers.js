import{a as g,i as l,S as m}from"./assets/vendor-188ea4b6.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function o(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(t){if(t.ep)return;t.ep=!0;const i=o(t);fetch(t.href,i)}})();const f="https://pixabay.com/api/",y="33796051-1e422d07d8c9fc912bc2a7eb4",b="per_page=15&image_type=photo&orientation=horyzontal&safesearch=true";class L{constructor(){this.page=1,this.search=""}async getImage(){const e=`${f}?key=${y}&q=${this.search}&page=${this.page}&${b}`,o=await g.get(e);return this.nextPage(),o.data}nextPage(){this.page+=1}resetPage(){this.page=1}}function x({webformatURL:s,largeImageURL:e,tags:o,likes:r,views:t,comments:i,downloads:n}){return`<div class="photo-card">
